...
import { useCreatorTour, TourStep } from "../contexts/CreatorTourContext";
...
export function useCreatorPageTour(pageId: string, steps: TourStep[], enabled: boolean = true) {
  const { hasSeenPageTour, startTour, restartTour, isRunning, currentPageTourId } = useCreatorTour();
