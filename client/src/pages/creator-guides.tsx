...
export default function CreatorGuidesPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-4 fx-page">
      <header>
        <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-foreground fx-text-in fx-text-glow"><span className="fx-text-sweep">Guides</span><span className="fx-caret ml-1">_</span></h1>
