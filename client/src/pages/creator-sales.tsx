...
export default function CreatorSalesPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4 fx-page">
      <header>
        <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-foreground fx-text-in fx-text-glow"><span className="fx-text-sweep">Sales Tracker</span><span className="fx-caret ml-1">_</span></h1>
